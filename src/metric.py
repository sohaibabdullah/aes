...
def calculateKappa(predictions,test_y):
    x=[]
    y=[]
    for i in range(0, 179):
        x.append(decodeOneHot(test_y[i])) 
    for i in range(0, 179):
        y.append(decodeOneHot(predictions[i]))

    return kappa(x, y, weights='quadratic')

    #print('QWK:',kappa(x, y, weights='quadratic'))
    #print('f1 Score:',f1_score_least_frequent(x,y))
